...
window.webcam = {
	...
	swf_url: protocol +'://168.62.38.168/jcuervo/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: protocol + '://168.62.38.168/jcuervo/js/shutter.mp3', // URI to shutter.mp3 sound
	api_url: protocol  + '://168.62.38.168/jcuervo/index.php/CaraWeb/SaveFoto', // URL to upload script
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : protocol + '://168.62.38.168/jcuervo/js/shutter.mp3';
	},
